...
class NerfstudioSplatfactoTrainOperator:
    ...
    def _fake_gaussian_ply_bytes(self) -> bytes:
        ...
        for index in range(50000):
            ...
            values[properties.index("x")] = float(index % 4) * 0.01
            values[properties.index("y")] = float(index // 4) * 0.01
            values[properties.index("z")] = 0.0
            ...
            rows.append(struct.pack("<" + "f" * len(properties), *values))
        header = "\n".join(
            [
                "ply",
